...
// Instead of doing this, we are going to use react context api,
// to be able to identify the contents of the basket, without prop drilling.
...
// Build a provider ,
// wrap the entire app inside of the provider (in index.js)
// and give it access to the data layer
